...
The response variable is the nest survival of a Mountain Plover determined as if the site is used or available, the 1s mean the nest successfully survived so the site is used, while the 0s mean the nest failed, either due to predation or abandonment so the site is available.
