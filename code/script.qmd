...
1.  Linear relationship between response and predictor variables
    ...
    Yes, I would expect a linear relationship between my X variable, screen time (minutes), and my Y variable, sleep duration (minutes).
...
1.  Homoscedasticity of error (constant variance)

    (Error should be the same throughout the range of predictor values in the model)
